...
<p>Statutory Sick Pay is the legal minimum an eligible employee receives from their employer during sickness absence. It is a common mistake to think SSP starts when contractual sick pay stops. It does not. SSP runs alongside contractual sick pay, and where an employer pays more than the statutory minimum, the SSP is normally included within that payment rather than paid on top of it. Only where there is no contractual scheme, or where contractual pay has fallen below the statutory amount, does SSP become the visible part of what you receive.</p><h2>What changed on 6 April 2026</h2><p>The Statutory Sick Pay rules were reformed with effect from 6 April 2026. It is now payable from the first qualifying day of sickness rather than after a period of unpaid waiting days, the earnings threshold that previously excluded many lower paid and part-time employees has been removed, and the amount is calculated as the lower of a proportion of average weekly earnings or the flat rate.</p><p>Two things follow. Anything written about sick pay before that date may describe a position that no longer applies, including older employer handbooks. And while more people now qualify for something from day one, Statutory Sick Pay was never designed to replace a working income, so the gap between it and normal earnings is the part worth planning around. The current rates and conditions are published on GOV.UK, and your own entitlement depends on your circumstances and your contract.</p>
...
<li>Contractual sick pay ends. Statutory Sick Pay is a legal minimum, and where an employer pays contractual sick pay it normally includes the statutory element rather than following on after it. The rules changed on 6 April 2026: Statutory Sick Pay is now payable from the first qualifying day of sickness rather than after a period of unpaid waiting days, the earnings threshold that previously excluded lower paid and part-time employees has been removed, and the amount is calculated as the lower of a proportion of average weekly earnings or the flat rate. Anything written before that date can therefore describe a position that no longer applies. The current rates and conditions are on GOV.UK, and your own entitlement depends on your circumstances. A new employer\'s terms may be considerably less generous.</li>
</ul>
